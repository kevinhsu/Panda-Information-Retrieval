...
//		Find top 10 ranked documents for each model for topic 401
//		GetDocTermStats gtdcs = new GetDocTermStats();
//		HashMap tmsts = gtdcs.GetDocLevelStats("FBIS3-10275");
//		Iterator iterator = tmsts.keySet().iterator();
//		while (iterator.hasNext()){
//			String key = iterator.next().toString();
//			int value = (Integer) tmsts.get(key);
